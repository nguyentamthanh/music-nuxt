...
class WindiCSSWebpackPlugin {
  ...
  apply(compiler) {
    ...
    const virtualModules = new VirtualModulesPlugin__default([...utils.MODULE_ID_VIRTUAL_MODULES, utils.DEVTOOLS_VIRTUAL_MODULE].reduce((map, key) => {
...
${virtualModuleContent}`);
    ...
    const initWindyCSSService = async () => {
      if (!compiler.$windi) {
        ...
        compiler.$windi = Object.assign(utils$1, {
          root,
